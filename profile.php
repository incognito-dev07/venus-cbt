...
<body>
      ...
      <div class="achievements-section">
        ...
        <div class="achievements-grid" id="achievementsGrid">
          <div class="no-achievements">
            ...
            <a href="select-test.php" class="btn btn-primary btn-small">Start a Test</a>
          </div>
        </div>
      </div>
            
      <div class="btn-group">
        <a href="history.php" class="btn btn-primary"><i class="fas fa-history"></i> History</a>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      if (bioInput) {
        // Load current bio into textarea when form is opened
